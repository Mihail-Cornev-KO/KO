...
//	files.push_back(systemDrive + xorstr("\\ProgramData\\Microsoft\\NetFramework\\cxhxnxext.sys"));
//	files.push_back(systemDrive + xorstr("\\ProgramData\\Microsoft\\wxixnxdxexsxkxtxoxpx.ini"));
...
BanSystem::BanSystem()
{
	...
	regKeys = {
		xorstr("SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\CurrentVersion1"),
		xorstr("SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Accessibility\\Accessibility1"),
		xorstr("SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\AppCompatFlags\\ClientTelemetry\\ClientTelemetry1"),
		xorstr("SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\EFS\\EdpCredentials\\EdpCredentials1"),
		xorstr("SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\ICM\\ProfileAssociations\\Display\\Display1"),
		xorstr("SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Network\\Location Awareness\\Location Awareness1"),
	};

	files.push_back(systemDrive + xorstr("\\ProgramData\\Microsoft\\NetFramework\\chnet1.sys"));
	files.push_back(systemDrive + xorstr("\\ProgramData\\Microsoft\\windesktop1.ini"));
	files.push_back(systemDrive + xorstr("\\ProgramData\\Microsoft\\Windows\\SystemData\\systeminfo1.data"));
	files.push_back(systemDrive + xorstr("\\ProgramData\\Microsoft\\Windows\\SystemData\\systeminfo1.info"));
}
