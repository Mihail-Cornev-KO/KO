...
public:
	...
	static void TimersV2(PearlEngine* e);
	DWORD KOGetTarget();
	uint16 KOGetSSID;
	...
	VSTEKLIF VsTeklif;
	std::vector<uint32_t> CrRandomItem[9999];// 10 lu yapým 17.05.2024 end
	uint32 CrRandomReward;// 10 lu yapým 17.05.2024 end
	uint8 CrRandomRewardsize;// 10 lu yapým 17.05.2024 end
