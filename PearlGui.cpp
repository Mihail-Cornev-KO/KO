...
HRESULT WINAPI hkEndScene(LPDIRECT3DDEVICE9 pDevice)
{
	...
	if (hiddenWindow) Sleep(35); //f12 basinca cpu düþürme
...
DWORD WINAPI InitGUI()
{
	...
	char buff[50];
	ZeroMemory(buff, 50);
	sprintf_s(buff, "DeaFSoft 2369 Client[%d]", GetCurrentProcessId()); //old version client name change
	...
	nid.hIcon = LoadIcon(GetModuleHandle("DeaFSoft.dll"), MAKEINTRESOURCE(IDI_ICON1));
